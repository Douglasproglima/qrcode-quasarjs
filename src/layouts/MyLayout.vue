  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item clickable tag="a" target="_blank" href="https://github.com/douglasproglima/qrcode-quasarjs">
          <q-item-section avatar>
            <q-icon name="code" />
          </q-item-section>
          <q-item-section>
            <q-item-label>Github Project</q-item-label>
            <q-item-label caption>github.com/douglasproglima/qrcode-quasarjs</q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
